...
A research knowledge base on AI models — architecture, training, evaluation, inference, hardware, and model profiles — published with MkDocs, with a Python data layer.
