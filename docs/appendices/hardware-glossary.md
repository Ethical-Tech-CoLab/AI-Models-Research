...
- [ ] Define every hardware term used in chapters 16 and 17.
- [ ] Define every precision format used in scripts/estimate_memory.py, with bytes per element.
- [ ] State the unit conventions, including gibibytes versus gigabytes, which are routinely conflated in vendor material.
- [ ] Record no vendor specifications in this file.
